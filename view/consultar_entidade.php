...
<?php if ($linha_usu['visualizarEntidade'] == 1 || $linha_usu['master'] == 1) { ?>
  <div class="main-content">
    <div class="panel-row">
      ...
      <?php }
      if ($linha_usu['editarEntidade'] == 1 || $linha_usu['master'] == 1) { ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  if ($linha_usu['master'] == 1) {
                    echo "<a  class='btn btn-danger' title='Excluir' href='../dao/excluir_entidade.php?idEntidade=" . $rows_entidade['idEntidade'] . "' onclick=\"return confirm('Tem certeza que deseja deletar esse registro?');\">" ?> <i class='fas fa-trash-alt'></i><?php echo "</a>";
                                                                                                                                                                                                                                                                        } ?>
