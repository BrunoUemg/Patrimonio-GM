...
?>
<?php if ($linha_usu['visualizarUnidade'] == 1 || $linha_usu['master'] == 1) { ?>
  <div class="main-content">
    <div class="panel-row">
      ...
      <?php }
      if ($linha_usu['editarUnidade'] == 1 || $linha_usu['master'] == 1) { ?>
        ...
        <table id="basic-datatables" class="table table-bordered">
          ...
          <tbody>
            <?php while ($rows_unidade = mysqli_fetch_assoc($resultado_unidade)) { 
               $select_entidade_usu = mysqli_query($con, "SELECT * FROM entidade_usuario where idUsuario = $_SESSION[idUsuario] and $rows_unidade[idEntidade]");
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php if ($linha_usu['master'] == 1) {
                    echo "<a  class='btn btn-danger' title='Excluir' href='../dao/excluir_unidade.php?idUnidade=" . $rows_unidade['idUnidade'] . "' onclick=\"return confirm('Tem certeza que deseja deletar esse registro?');\">" ?> <i class='fas fa-trash-alt'></i><?php echo "</a>";
                                                                                                                                                                                                                                                                                                          } ?>
