...
?>
<?php if ($linha_usu['visualizarTipoSubTipo'] == 1 || $linha_usu['master'] == 1) { ?>
  <div class="main-content">
    <div class="panel-row">
      ...
      <?php }
      if ($linha_usu['editarTipoSubTipo'] == 1 || $linha_usu['master'] == 1) { ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php if ($linha_usu['master'] == 1) {
                    echo "<a  class='btn btn-danger' title='Excluir' href='../dao/excluir_tipo.php?idTipo=" . $rows_tipo['idTipo'] . "' onclick=\"return confirm('Tem certeza que deseja deletar esse registro?');\">" ?> <i class='fas fa-trash-alt'></i><?php echo "</a>";
                                                                                                                                                                                                                                                                                                } ?>
