...
?>
<?php if ($linha_usu['visualizarSala'] == 1 || $linha_usu['master'] == 1) { ?>
  ...
  <div class="main-content">
    <div class="panel-row">
      ...
      <?php }
      if ($linha_usu['editarSala'] == 1 || $linha_usu['master'] == 1) { ?>
        ...
        <table id="basic-datatables" class="table table-bordered">
          ...
          <tbody>
            <?php while ($rows_sala = mysqli_fetch_assoc($resultado_sala)) {
               $select_entidade_usu = mysqli_query($con, "SELECT * FROM entidade_usuario where idUsuario = $_SESSION[idUsuario] and $rows_sala[idEntidade]");
            ...
            ?>
                <tr>
                  ...
                  <td>
                    ...
                    <?php  } ?>
                    <?php if ($linha_usu['gerarPDF_ResponsavelSala'] == 1 || $linha_usu['master'] == 1) { ?>
                    ...
                    <?php if ($linha_usu['master'] == 1) {
                      echo "<a  class='btn btn-danger' title='Excluir' href='../dao/excluir_sala.php?idSala=" . $rows_sala['idSala'] . "' onclick=\"return confirm('Tem certeza que deseja deletar esse registro?');\">" ?> <i class='fas fa-trash-alt'></i><?php echo "</a>";
                                                                                                                                                                                                                                                                                                } ?>
